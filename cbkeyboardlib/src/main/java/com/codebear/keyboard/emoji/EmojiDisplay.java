...
public class EmojiDisplay {
    ...
    public static void emojiDisplay(Context context, Spannable spannable, String emojiHex, int fontSize, int start,
                                    int end) {
    ...
    public static Drawable getDrawable(Context context, String emojiName) {
        ...
        try {
            return Build.VERSION.SDK_INT >= 21 ? context.getResources().getDrawable(resID, null) : context
